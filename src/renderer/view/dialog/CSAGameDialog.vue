  ...
  <div>
    <dialog ref="dialog" class="root">
      ...
      <div class="form-area scroll">
        <div v-if="!logEnabled" class="form-area warning">
          <div class="note">
            {{ t.someLogsDisabled }}
      ...
      <div class="main-buttons">
        ...
        <button class="standard" data-hotkey="Escape" @click="onCancel()">
          {{ t.cancel }}
        </button>
      </div>
    </dialog>
